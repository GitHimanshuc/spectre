 ...
 */
class ScaledKerrSchild : public AnalyticSolution<3_st>,
 ...
 public:
  ...
  ScaledKerrSchild(double mass, const std::array<double, 3>& dimensionless_spin,
                   const std::array<double, 3>& center,
                   const Options::Context& context = {});

  ScaledKerrSchild(double mass, double scale,
                   const std::array<double, 3>& dimensionless_spin,
                   const std::array<double, 3>& center,
                   const Options::Context& context = {});

  explicit ScaledKerrSchild(CkMigrateMessage* /*msg*/);
  ...
  ScaledKerrSchild() = default;
  ScaledKerrSchild(const ScaledKerrSchild& /*rhs*/) = default;
  ScaledKerrSchild& operator=(const ScaledKerrSchild& /*rhs*/) = default;
  ScaledKerrSchild(ScaledKerrSchild&& /*rhs*/) = default;
  ScaledKerrSchild& operator=(ScaledKerrSchild&& /*rhs*/) = default;
  ~ScaledKerrSchild() = default;
  ...
  class IntermediateComputer {
   public:
    using CachedBuffer = ScaledKerrSchild::CachedBuffer<DataType, Frame>;

    IntermediateComputer(const ScaledKerrSchild& solution,
                         const tnsr::I<DataType, 3, Frame>& x);

    const ScaledKerrSchild& solution() const { return solution_; }
   ...
   private:
    const ScaledKerrSchild& solution_;
...
SPECTRE_ALWAYS_INLINE bool operator==(const ScaledKerrSchild& lhs,
                                      const ScaledKerrSchild& rhs) {
